...
/**
 * InterviewDate generated by hbm2java
 */
@Entity
@Table(name="interview_date"
    ,catalog="e2rp"
)
public class InterviewDate  implements java.io.Serializable {
    ...
    public InterviewDate(String postName, String interviewDate) {
